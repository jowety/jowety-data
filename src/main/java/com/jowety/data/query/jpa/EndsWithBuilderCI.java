...
public class EndsWithBuilderCI  extends PredicateBuilderBase {

	public EndsWithBuilderCI(boolean negative) {
		super(negative);
	}
	...
	public <X> Predicate build(CriteriaBuilder cb, Root<X> from, Filter<X> filter, Map<String, Path> pathMap) {
		if(filter.getRightSide().getType()== ExpType.LITERAL &&
			...
			throw new RuntimeException(
					"Filter values for ENDSWITH MatchMode must be of type java.lang.String");
